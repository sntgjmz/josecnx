// NIKI collection generated from public/Niki/.
const nikiArtwork = 'from-indigo-600 via-purple-500 to-pink-900'
const nikiAlbumCovers = {
  'Buzz': '/covers/niki-buzz-album.png',
  'Live at The Wiltern': '/covers/niki-liveatwiltern-album.png',
  'MOONCHILD': '/covers/niki-moonchild-album.png',
  'Nicole': '/covers/niki-nicole-album.png',
  'Zephyr': '/covers/niki-zephyr-album.jpg',
}
...
const nikiTracks = [
  ...
  },
  {
    ...
    "src": "/Niki/Buzz/Did You Like Her In The Morning_spotdown.org.mp3",
    "duration": "3:30"
  },
  {
    "artist": "NIKI",
  ...
  },
  {
    "artist": "NIKI",
    "album": "MOONCHILD",
    "title": "If There's Nothing Left",
    "src": "/Niki/MOONCHILD/If There's Nothing Left_spotdown.org.mp3",
    "duration": "3:30"
  },
  {
    "artist": "NIKI",
  ...
  },
  {
    ...
    "album": "Zephyr",
    "title": "Say My Name",
    "src": "/Niki/Zephyr/Say My Name_spotdown.org.mp3",
    "duration": "3:12"
  },
  {
    "artist": "NIKI",
...
export const nikiLibraryTracks = nikiTracks.map((track, index) => ({
  id: `niki-${index}-${track.src.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')}`,
  ...track,
  artwork: nikiArtwork,
  artworkSrc: nikiAlbumCovers[track.album],
  mood: 'NIKI collection',
}))